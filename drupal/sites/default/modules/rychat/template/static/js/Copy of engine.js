...
(function ($) {
    ...
    var friendListStr = '<li targetType="4" targetId="{0}" targetName="{1}"><span class="user_img"><img src="' + basepath + 'static/images/personPhoto.png"/></span> <span class="user_name">{1}</span></li>';
